    ...
    subpolicies = List(
	    ...
	    new Policy("policyset:2")(
	      ...
	      subpolicies = List(
		      ...
		      new Rule("policy:4")(
		        effect = Permit,
		        condition = ((subject.department === "cardiology") | (subject.department === "elder_care") | (subject.department === "emergency"))
		                    & (subject.triggered_breaking_glass | resource.operator_triggered_emergency | resource.indicates_emergency)),
		      ...
		      new Policy("policyset:4")(
		        ...
		        subpolicies = List(
			        // Permit for head physician.
			        new Rule("policy:7")(
			            condition = subject.is_head_physician,
			            effect = Permit),
	    ...
	    new Policy("policyset:7")(
	      ...
	      subpolicies = List(
		      ...
		      // Nurses can only access the PMS during their shifts.
		      new Rule("policy:15")(
		          condition = !((environment.currentDateTime gteq subject.shift_start) & (environment.currentDateTime lteq subject.shift_stop)),
		          effect = Deny),
		      ...
		      // Nurses can only view the patient's status of the last five days.
		      new Rule("policy:17")(
		          condition = !(environment.currentDateTime lteq (resource.created + 5.days)),
		          effect = Deny),
